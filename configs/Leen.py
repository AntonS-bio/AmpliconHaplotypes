class configData:
    def __init__(self):
        self.wd = "/mnt/storage5/anton/Amplicon/Leen/"  #directory in which any work will be done file will be
        self.bamDir = "/mnt/storage9/leen/Minion/mapping/"  #directory which will be scanned for bam files
