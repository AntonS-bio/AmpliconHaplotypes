class configData:
    def __init__(self):
        self.wd = "/mnt/storage5/anton/Amplicon/Ashley/"  #directory in which any work will be done file will be
        self.bamDir = "/mnt/storage5/anton/Amplicon/Ashley/bams/"  #directory which will be scanned for bam files
