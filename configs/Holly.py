class configData:
    def __init__(self):
        self.wd = "/mnt/storage5/anton/Amplicon/Holly/"  #directory in which any work will be done file will be
        self.bamDir = "/mnt/storage5/anton/Amplicon/HollyBam/"  #directory which will be scanned for bam files
        ...
        self.maxDistanceBetweenReads=50 #any regions where starts and ends are both fewer than this bases apart are considered one region
        ...
        self.MaxReadsToOutput=2000 #use for downsampling of very large datasets