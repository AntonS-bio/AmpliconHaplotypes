class configData:
    def __init__(self):
        self.wd = "/mnt/storage5/anton/Amplicon/LeenNewBarcodes/"  #directory in which any work will be done file will be
        self.bamDir = "/mnt/storage9/leen/amplicon-seq/2022_01_05_NewBarcodesTrial/Multiclone/"  #directory which will be scanned for bam files
